  ...
  [
    [629],
    {
      ...
      76629: function (e, t, a) {
        ...
        var n = a(66252)
        const l = { class: 'menu' }
        function o(e, t, a, o, i, r) {
          const s = (0, n.up)('PageContent')
          return (
            (0, n.wg)(),
            (0, n.iD)('div', l, [
              (0, n.Wm)(
        ...
        var s = (0, n.aZ)({
            name: 'wj-menu',
            components: { PageContent: i.Z },
            setup() {
              return { contentTableConfig: r }
            }
          }),
          p = a(83744)
        const c = (0, p.Z)(s, [['render', o]])
        var d = c
      }
    }
  ]
)
//# sourceMappingURL=629.a7a9c81a.js.map
